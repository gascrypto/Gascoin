...
const string strMessageMagic = "Gascoin Signed Message:\n";
...
// Gascoin: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Gascoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "2015 GasCoin";
        CTransaction txNew;
        txNew.nTime = 1422557095;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xc0be42597494956a83e534da2b6a6b034b668690a5fc74ed655022328ad1a334"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xff, 0xdd, 0x77, 0x17 };
